...
public class PresenterMessenger implements ProviderPresenterMessenger {
    ...
    private ViewMessenger viewMessenger;
    private ChatModel chatModelCurrent;
    private MessagerAdapter messagerAdapter;
    private UiMessengerActivity uiMessengerActivity;
    private UserMainInformation userMainInformation = UserMainInformation.getInstance();
    private FillColor fillColor = FillColor.getInstance();
    private boolean existence = false;
    private ConstChat constChat = ConstChat.getInstance();
    private SortAlgorithms sortAlgorithms = new SortAlgorithms();
    private ArrayList<Uri> path;
    private CompressionImages compressionImages;
    private FirebaseNotification firebaseNotification = FirebaseNotification.getInstance();
