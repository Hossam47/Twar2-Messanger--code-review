...
public class processingMessengerAdapter implements ProviderMessengerAdapter {

    private Context context;
    private ChatModel chatModel;
    private UserMainInformation userMainInformation = UserMainInformation.getInstance();
    private GetTime getTime = GetTime.getInstance();
    private ImageProcess imageProcess = ImageProcess.getInstance();

    public processingMessengerAdapter(Context context, ChatModel chatModel) {
